...
{
  $Shipment::UPS::WSDL::ShipElements::VoidShipmentResponse::VERSION = '0.01120470';
}
use strict;
use warnings;
...
{
  $Shipment::UPS::WSDL::ShipElements::VoidShipmentResponse::_SummaryResult::VERSION = '0.01120470';
}
use strict;
use warnings;
{
