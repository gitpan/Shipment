...
BEGIN {
  $Shipment::UPS::WSDL::ShipElements::VoidShipmentRequest::VERSION = '0.01111361';
}
use strict;
use warnings;
...
BEGIN {
  $Shipment::UPS::WSDL::ShipElements::VoidShipmentRequest::_VoidShipment::VERSION = '0.01111361';
}
use strict;
use warnings;
{
