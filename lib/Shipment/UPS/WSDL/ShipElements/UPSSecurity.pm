...
BEGIN {
  $Shipment::UPS::WSDL::ShipElements::UPSSecurity::VERSION = '0.01111450';
}
use strict;
use warnings;
...
BEGIN {
  $Shipment::UPS::WSDL::ShipElements::UPSSecurity::_ServiceAccessToken::VERSION = '0.01111450';
}
use strict;
use warnings;
{
...
BEGIN {
  $Shipment::UPS::WSDL::ShipElements::UPSSecurity::_UsernameToken::VERSION = '0.01111450';
}
use strict;
use warnings;
{
