...
BEGIN {
  $Shipment::UPS::WSDL::RateElements::UPSSecurity::VERSION = '0.01112650';
}
use strict;
use warnings;
...
BEGIN {
  $Shipment::UPS::WSDL::RateElements::UPSSecurity::_ServiceAccessToken::VERSION = '0.01112650';
}
use strict;
use warnings;
{
...
BEGIN {
  $Shipment::UPS::WSDL::RateElements::UPSSecurity::_UsernameToken::VERSION = '0.01112650';
}
use strict;
use warnings;
{
