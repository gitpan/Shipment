...
BEGIN {
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::VERSION = '0.01112490';
}
use strict;
use warnings;
...
BEGIN {
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::_Property::VERSION = '0.01112490';
}
use strict;
use warnings;
{
...
BEGIN {
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::_Property::XmlAttr::VERSION = '0.01112490';
}
