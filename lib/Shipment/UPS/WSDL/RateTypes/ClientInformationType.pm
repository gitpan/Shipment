...
{
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::VERSION = '0.1';
}
use strict;
use warnings;
...
{
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::_Property::VERSION = '0.1';
}
use strict;
use warnings;
{
...
{
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::_Property::XmlAttr::VERSION = '0.1';
}
