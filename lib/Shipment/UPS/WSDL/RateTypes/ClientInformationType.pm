...
{
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::VERSION = '0.14';
}
use strict;
use warnings;
...
{
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::_Property::VERSION = '0.14';
}
use strict;
use warnings;
{
...
{
  $Shipment::UPS::WSDL::RateTypes::ClientInformationType::_Property::XmlAttr::VERSION = '0.14';
}
