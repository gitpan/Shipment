...
BEGIN {
  $Shipment::FedEx::WSDL::RateTypes::Dimensions::VERSION = '0.01111360';
}
use strict;
use warnings;
...
BEGIN {
  $Shipment::FedEx::WSDL::RateTypes::Dimensions::_Height::VERSION = '0.01111360';
}
use strict;
use warnings;
{
...
BEGIN {
  $Shipment::FedEx::WSDL::RateTypes::Dimensions::_Length::VERSION = '0.01111360';
}
use strict;
use warnings;
{
...
BEGIN {
  $Shipment::FedEx::WSDL::RateTypes::Dimensions::_Width::VERSION = '0.01111360';
}
use strict;
use warnings;
{
