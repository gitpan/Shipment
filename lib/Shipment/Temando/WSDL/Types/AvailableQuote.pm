...
{
  $Shipment::Temando::WSDL::Types::AvailableQuote::VERSION = '0.1';
}
use strict;
use warnings;
...
{
  $Shipment::Temando::WSDL::Types::AvailableQuote::_adjustments::VERSION = '0.1';
}
use strict;
use warnings;
{
...
{
  $Shipment::Temando::WSDL::Types::AvailableQuote::_articles::VERSION = '0.1';
}
use strict;
use warnings;
{
...
{
  $Shipment::Temando::WSDL::Types::AvailableQuote::_extras::VERSION = '0.1';
}
use strict;
use warnings;
{
...
{
  $Shipment::Temando::WSDL::Types::AvailableQuote::_inclusions::VERSION = '0.1';
}
use strict;
use warnings;
{
...
{
  $Shipment::Temando::WSDL::Types::AvailableQuote::_AvailableQuote::XmlAttr::VERSION = '0.1';
}
