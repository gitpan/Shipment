...
{
  $Shipment::Temando::WSDL::Elements::updateRequest::VERSION = '0.1';
}
use strict;
use warnings;
...
{
  $Shipment::Temando::WSDL::Elements::updateRequest::_anythings::VERSION = '0.1';
}
use strict;
use warnings;
{
...
{
  $Shipment::Temando::WSDL::Elements::updateRequest::_articles::VERSION = '0.1';
}
use strict;
use warnings;
{
