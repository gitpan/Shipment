...
{
  $Shipment::Temando::WSDL::Elements::confirmManifestResponse::VERSION = '0.01120470';
}
use strict;
use warnings;
...
{
  $Shipment::Temando::WSDL::Elements::confirmManifestResponse::_requests::VERSION = '0.01120470';
}
use strict;
use warnings;
{
