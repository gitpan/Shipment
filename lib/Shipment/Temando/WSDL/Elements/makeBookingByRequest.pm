...
{
  $Shipment::Temando::WSDL::Elements::makeBookingByRequest::VERSION = '0.01121490';
}
use strict;
use warnings;
...
{
  $Shipment::Temando::WSDL::Elements::makeBookingByRequest::_anythings::VERSION = '0.01121490';
}
use strict;
use warnings;
{
