...
has '+bill_type' => (isa => 'BillingOptions',);
...
enum 'PackageOptions' =>
  [qw( custom envelope tube box pack FEDEX_10KG_BOX FEDEX_25KG_BOX )];

has '+package_type' => (isa => 'PackageOptions',);
...
sub _build_services {
    ...
    try {
        ...
        try {
            ...
            $self->error(
                $response->get_Notifications()->get_Message->get_value);
        }
        catch {
